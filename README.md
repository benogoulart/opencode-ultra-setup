...
| [opencode-agent-skills](docs/agent-skills.md) | skills reutilizáveis, carregadas sob demanda | ✅ instalado |
...
| [Command Code GOAT](docs/plano.md) | provider de API (GPT-5.6 Sol, GLM 5.2, Kimi K2.7 Code, DeepSeek V4 Flash) | 🎯 planejado |
